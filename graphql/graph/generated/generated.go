...
type MutationResolver interface {
	...
	Authorize(ctx context.Context, input model.AuthorizeRequest) (*model.AuthorizeResponse, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "AuthorizeResponse.jwtToken":
		if e.complexity.AuthorizeResponse.JwtToken == nil {
			break
		}

		return e.complexity.AuthorizeResponse.JwtToken(childComplexity), true
	...
	case "Mutation.helthCheck":
		if e.complexity.Mutation.HelthCheck == nil {
			break
		}
...
var sources = []*ast.Source{
	{Name: "schema/authCommand.graphql", Input: `input AuthorizeRequest {
  email: String!
  password: String!
}
...
func (ec *executionContext) _AuthorizeResponse_jwtToken(ctx context.Context, field graphql.CollectedField, obj *model.AuthorizeResponse) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
...
func (ec *executionContext) _Mutation_helthCheck(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().HelthCheck(rctx)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_helthCheck(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().HelthCheck(rctx)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
var authorizeResponseImplementors = []string{"AuthorizeResponse"}

func (ec *executionContext) _AuthorizeResponse(ctx context.Context, sel ast.SelectionSet, obj *model.AuthorizeResponse) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, authorizeResponseImplementors)
	...
	for i, field := range fields {
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("AuthorizeResponse")
		case "jwtToken":
			out.Values[i] = ec._AuthorizeResponse_jwtToken(ctx, field, obj)
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "helthCheck":
			out.Values[i] = ec._Mutation_helthCheck(ctx, field)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "authorize":
